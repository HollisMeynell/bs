...
import l.f.mappool.entity.Notation;
...
@Component
public interface NotationRepository extends JpaRepository<Notation, Integer>, JpaSpecificationExecutor<Integer> {
    ...
    List<Notation> searchAllByTags(String tag);
    Optional<Notation> findByBidAndUserId(Long bid, Long userId);
}
